...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-177-grunbaum-s-conjecture-faabff20-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-177"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-177-grunbaum-s-conjecture-faabff20-v1",
      "problem_contract_sha256": "f71cebd574bd7ee67b78f470c2d13184249daa0b8237e8628dcd23cb037dcfb4",
      "problem_id": "problem:um-opg-177-grunbaum-s-conjecture-faabff20",
      "route_id": "route:um-opg-177-grunbaum-s-conjecture-faabff20-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-177-grunbaum-s-conjecture-faabff20-source-fidelity-01",
      "graph_id": "graph:um-opg-177-grunbaum-s-conjecture-faabff20-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-177-grunbaum-s-conjecture-faabff20-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-177-grunbaum-s-conjecture-faabff20-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture If $G$ is a simple loopless triangulation of an orientable surface, then the dual of $G$ is 3-edge-colorable."
          },
          "statement_sha256": "2632728805a8893ab6590c1d5610ef3470e7f582b51d7534a4c42b2575955638"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-177-grunbaum-s-conjecture-faabff20-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-177-grunbaum-s-conjecture-faabff20-root",
      "route_id": "route:um-opg-177-grunbaum-s-conjecture-faabff20-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-177-cac89e3eb106",
        "url": "https://www.unsolvedmath.com/problems/OPG-177"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
